...
//!
//! Corpus invariants, asserted: 66 roots, 2772 cells, 3259 forms. These are
//! facts about the repo, pinned by its own golden suite
//! (`derivation_set_shape_matches_the_audited_numbers`): 308 root×pada×lakāra
//! blocks × 9 cells, plus 487 `ALTERNATES` rows. If this harness's
...
//!
//! Optionally dump the full 2772-cell table:
//!
