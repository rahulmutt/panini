...
//!
//! What it compares: for each of the 79 curated roots, for each pada the root
...
//!
//! Corpus invariants, asserted: 79 roots, 3564 cells, 4483 forms. These are
//! facts about the repo, pinned by its own golden suite
//! (`derivation_set_shape_matches_the_audited_numbers`): 396 root×pada×lakāra
//! blocks × 9 cells, plus 919 `ALTERNATES` rows. If this harness's
...
//!
//! Optionally dump the full 3564-cell table:
//!
...
fn main() {
    ...
    assert_eq!(n_forms, 4483, "forms: 3564 cells + 919 ALTERNATES rows");
    assert_eq!(
        n_branches, n_forms,
