...
//! admits (seven for the ubhayapadī roots), for each of the four lakāras this engine
...
//!
//! Corpus invariants, asserted: 53 roots, 2160 cells, 2496 forms. These are
...
//!
//! Optionally dump the full 2160-cell table:
//!
