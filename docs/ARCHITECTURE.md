...
engine's junction witnesses: 8.4.55 cartva (√ad), 8.2.25 dhi ca, which elides
an aṅga-final `s` before a Dh-initial affix (ADve, vaDve), and 8.3.59
ādeśapratyayayoḥ, the engine's first ṣatva (Seze, Sezva). √śī also lands
7.4.21 śīṅaḥ sārvadhātuke guṇaḥ — the gaṇa's only visible guṇa — and 7.1.6
śīṅo ruṭ (Serate); see `docs/superpowers/specs/2026-07-25-adadi-si-5f-design.md`
for the full rule analysis rather than restating it here. `derive`
