...
padas — all nine ubhayapadī roots in the curated set (√nī, √tud, √rudh,
√bhid, √kṣud, √yuj, √tṛd, √ric and √vic) derive a full parasmaipada and a full
ātmanepada paradigm, so a single surface can be genuinely pada-ambiguous.
Twenty-two surfaces are, each of them a pinned cell in both padas at once:
