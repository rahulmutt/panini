...
fn tinanta_rule_order_is_pinned() {
    let expected = [
        ...
        "2.4.72", "1.2.4", "6.4.71", "6.4.72", "7.3.100", "7.1.5", "7.1.6", "7.1.3", "7.2.79",
        "7.2.80", "7.2.81", "7.4.21", "7.3.84", "7.3.86", "6.1.78", "7.3.101", "6.1.101", "6.1.96",
        "6.1.90", "6.1.97", "6.1.87", "6.1.66", "6.4.105", "6.4.101", "8.2.77", "8.2.23", "8.2.25",
        "8.3.15", "8.3.59", "8.4.55",
    ];
