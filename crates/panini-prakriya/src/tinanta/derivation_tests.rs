...
fn tinanta_rule_order_is_pinned() {
    let expected = [
        ...
        "7.2.79", "7.2.80", "7.2.81", "6.4.23", "7.4.21", "7.3.84", "7.3.86", "7.3.92", "7.3.84",
        "6.4.87", "6.4.77", "6.1.77", "6.1.78", "7.3.101", "6.4.112", "6.4.113", "6.1.101",
        ...
        "8.3.13", "8.4.53", "8.4.55", "8.4.1", "8.4.2", "8.4.58", "8.4.65", "8.4.56",
    ];
