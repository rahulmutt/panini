...
///
/// The √kṛ specials 6.4.110/6.4.108/6.4.109 sit between the second
/// 7.3.84 and 6.4.87, ABOVE 6.1.77 below: 6.4.110 must turn `kar` into
/// `kur` before the tanādi `u` is subject to 6.1.77's yaṇ (u → v), or
/// kurvanti would derive from the wrong aṅga text. See guna.rs's own
...
fn tinanta_rule_order_is_pinned() {
    let expected = [
        ...
        "3.4.111", "3.1.83", "1.2.4", "6.1.10", "7.4.62", "6.4.71", "6.4.72", "6.1.73", "7.3.100",
        "7.1.5", "7.1.6", "7.1.3", "7.2.79", "7.2.80", "7.2.81", "6.4.23", "7.4.21", "7.3.84",
        "7.3.86", "7.3.86", "7.3.92", "7.3.84", "6.4.110", "6.4.108", "6.4.109", "6.4.87",
        "6.4.77", "6.1.77", "6.1.78", "7.3.101", "6.4.112", "6.4.113", "6.1.101", "6.1.96",
        "6.4.106", "6.4.107", "6.1.90", "6.1.97", "6.1.87", "6.1.66", "6.4.105", "6.4.101",
        "6.4.111", "8.2.77", "8.2.23", "8.2.25", "8.2.30", "8.2.31", "8.2.39", "8.2.40", "8.2.41",
