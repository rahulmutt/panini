...
fn tinanta_rule_order_is_pinned() {
    let expected = [
        ...
        "6.1.96", "6.4.106", "6.4.107", "6.1.90", "6.1.97", "6.1.87", "6.1.66", "6.4.105",
        "6.4.101", "6.4.111", "8.2.77", "8.2.23", "8.2.25", "8.2.30", "8.2.31", "8.2.39", "8.2.40",
        "8.2.41", "8.2.74", "8.2.75", "8.2.73", "8.3.15", "8.3.24", "8.3.59", "8.4.40", "8.4.41",
        "8.3.13", "8.4.53", "8.4.54", "8.4.55", "8.4.1", "8.4.2", "8.4.58", "8.4.65", "8.4.56",
    ];
