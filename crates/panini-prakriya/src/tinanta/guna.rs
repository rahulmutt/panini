...
mod tests {
    ...
    fn pugantalaghupadhasya_one_char_anga_returns_false_without_panic() {
        ...
        // cleanly.
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("d"), Term::new("a")]),
            log: vec![],
            ..Default::default()
        };
    ...
    fn pugantalaghupadhasya_two_char_ik_penult_fires() {
        ...
        // of firing.
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("id"), Term::new("a")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.86").unwrap();
    ...
    fn pugantalaghupadhasya_skips_vowel_final_anga() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("Bfu"), Term::new("a")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.86").unwrap();
    ...
    fn pugantalaghupadhasya_uses_n_minus_2_not_n_over_2() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("aBiur"), Term::new("a")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.86").unwrap();
    ...
    fn pugantalaghupadhasya_single_term_still_applies_guna() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("vft")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.86").unwrap();
    ...
    fn eco_yavayavah_athematic_arm_requires_an_empty_shap() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("Se"), Term::new("ya"), Term::new("Iran")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "6.1.78").unwrap();
    ...
    fn sarvadhatukardhadhatukayoh_blocks_guna_when_vikarana_is_ngit() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("nI"), Term::new("ya")]),
            log: vec![],
            ..Default::default()
        };
    ...
    fn sarvadhatukardhadhatukayoh_blocks_guna_when_luk_shap_ending_is_ngit() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("nI"), Term::new(""), Term::new("te")]),
            log: vec![],
            ..Default::default()
        };
    ...
    fn sarvadhatukardhadhatukayoh_applies_guna_when_luk_shap_ending_is_not_ngit() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("nI"), Term::new(""), Term::new("ti")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.84").unwrap();
    ...
    fn pugantalaghupadhasya_blocks_guna_when_luk_shap_ending_is_ngit() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("vft"), Term::new(""), Term::new("te")]),
            log: vec![],
            ..Default::default()
        };
        p.terms[ENDING].add(Tag::Ngit);
    ...
    fn pugantalaghupadhasya_applies_guna_when_luk_shap_ending_is_not_ngit() {
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("vft"), Term::new(""), Term::new("ti")]),
            log: vec![],
            ..Default::default()
        };
        let rule = rules().find(|r| r.id == "7.3.86").unwrap();
    ...
    fn pugantalaghupadhasya_tanadi_arm_is_vikalpa_and_ngit_blind() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("tfR"), Term::new("u"), Term::new("anti")]),
            ..Default::default()
        };
        ...
        assert_eq!(p.terms[ANGA].text, "tarR");
    }
    ...
    fn pugantalaghupadhasya_tanadi_arm_declines_a_upadha_and_final_ik() {
        ...
        for root in ["tan", "kf"] {
            let mut p = Prakriya {
                terms: with_slots(vec![Term::new(root), Term::new("u"), Term::new("ti")]),
                ..Default::default()
            };
            p.terms[ANGA].add(Tag::Dhatu);
            p.terms[ANGA].add(Tag::Tanadi);
    ...
    fn pugantalaghupadhasya_tanadi_arm_declines_a_vowel_final_anga() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("fu"), Term::new("u"), Term::new("ti")]),
            ..Default::default()
        };
        p.terms[ANGA].add(Tag::Dhatu);
        p.terms[ANGA].add(Tag::Tanadi);
    ...
    fn shna_prakriya(anga: &str, ending: &str, ngit: bool) -> Prakriya {
        ...
        Prakriya {
            terms: with_slots(vec![Term::new(anga), vik, end]),
            log: vec![],
            ..Default::default()
        }
    }
    ...
    fn second_7_3_84_gunates_shnu_before_a_pit_ending() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("Ap"), Term::new("nu"), Term::new("ti")]),
            ..Default::default()
        };
    ...
    fn second_7_3_84_blocked_by_a_ngit_ending() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("Ap"), Term::new("nu"), Term::new("taH")]),
            ..Default::default()
        };
        p.terms[ENDING].add(Tag::Ngit);
        assert!(!(second_7_3_84().apply)(&mut p));
    ...
    fn second_7_3_84_declines_on_kryadi_shni() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("kliS"), Term::new("nI"), Term::new("taH")]),
            ..Default::default()
        };
        p.terms[ENDING].add(Tag::Ngit);
        assert!(!(second_7_3_84().apply)(&mut p));
    ...
    fn hushnuvoh_yields_yan_for_a_vowel_final_root() {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("hi"), Term::new("nu"), Term::new("anti")]),
            ..Default::default()
        };
        p.terms[SHAP].add(Tag::Vikarana);
    ...
    fn shnu_vowel_rules_never_touch_another_ganas_vikarana() {
        ...
        for shap in ["nA", "nI", "n", "a", "ya", "Ana", ""] {
            let mut p = Prakriya {
                terms: with_slots(vec![Term::new("kliS"), Term::new(shap), Term::new("anti")]),
                ..Default::default()
            };
            p.terms[SHAP].add(Tag::Vikarana);
            for id in ["6.4.87", "6.4.77"] {
    ...
    fn kr_prakriya(ending: &str, ngit: bool) -> Prakriya {
        ...
        let mut p = Prakriya {
            terms: with_slots(vec![Term::new("kar"), Term::new("u"), Term::new(ending)]),
            ..Default::default()
        };
        p.terms[ANGA].add(Tag::Dhatu);
    ...
    fn ata_ut_fires_only_before_ngit_sarvadhatuka() {
        ...
        assert_eq!(p.terms[ANGA].text, "kur");
        ...
        assert!((r.apply)(&mut p));
        assert_eq!(p.terms[ANGA].text, "akur");
    }
    ...
    fn ata_ut_uses_n_minus_2_not_n_over_2() {
        ...
        assert!((r.apply)(&mut p));
        assert_eq!(p.terms[ANGA].text, "vikur");
    }
